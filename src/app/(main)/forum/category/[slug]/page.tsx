...
export default function ForumCategoryPage() {
  ...
  const {
    ...
    queryKey: ['forum', 'threads', { categoryId: currentCategory?.id, sort }],
    queryFn: ({ pageParam = 1 }) =>
      getThreads({ categoryId: currentCategory?.id, sort }, pageParam, 20),
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <PageHeader
          ...
          actions={
            <Link href={`/forum/create?category=${slug}`}>
              <Button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          {isCategoriesLoading ? (
            ...
            <CategoryList categories={categories} activeCategory={slug} />
          )}
        </div>
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="ჯერ არ არის თემები ამ კატეგორიაში"
              action={
                <Link href={`/forum/create?category=${slug}`}>
