...
import { getAdminListings, deleteAdminListing } from '@/lib/api/admin';
...
import { ListingsTable, ContentTableSkeleton } from '@/components/admin/content-table';
...
export default function AdminListingsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: queryKeys.adminListings(filters as Record<string, unknown>),
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={() => listingToDelete && deleteMutation.mutate(listingToDelete)}
            >
              Delete
            </AlertDialogAction>
          </AlertDialogFooter>
